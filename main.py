...
METRIC_LIMIT: t.Final[t.Optional[int]] = None
...
BOSSES: t.Final[t.List[Metric]] = [
    ...
    Metric("Scorpia", 60, 1),
    Metric("Scurrius", 61, 1),
    Metric("Shellbane Gryphon", 62, 1),
    Metric("Skotizo", 63, 1),
    Metric("Sol Heredit", 64, 1),
    Metric("Spindel", 65, 1),
    Metric("Tempoross", 66, 1),
    Metric("The Gauntlet", 67, 1),
    Metric("The Corrupted Gauntlet", 68, 1),
    Metric("The Hueycoatl", 69, 1),
    Metric("The Leviathan", 70, 1),
    Metric("The Royal Titans", 71, 1),
    Metric("The Whisperer", 72, 1),
    Metric("Theatre of Blood", 73, 1),
    Metric("Theatre of Blood: Hard Mode", 74, 1),
    Metric("Themonuclear Smoke Devil", 75, 1),
    Metric("Tombs of Amascut", 76, 1),
    Metric("Tombs of Amascut: Expert Mode", 77, 1),
    Metric("TzKal-Zuk", 78, 1),
    Metric("TzTok-Jad", 79, 1),
    Metric("Vardorvis", 80, 1),
    Metric("Venenatis", 81, 1),
    Metric("Vet'ion", 82, 1),
    Metric("Vorkath", 83, 1),
    Metric("Wintertodt", 84, 1),
    Metric("Yama", 85, 1),
    Metric("Zalcano", 86, 1),
    Metric("Zulrah", 87, 1),
]
...
async def fetch_all_leaders(session: ClientSession) -> t.List[HiscorePlayer]:
    metric_limit = METRIC_LIMIT if METRIC_LIMIT else len(NOT_ALL_METRICS)
